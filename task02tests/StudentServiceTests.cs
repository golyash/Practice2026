...
public class StudentServiceTests
{
    ...
    public void GetStudentsWithMinAverageGrade_ReturnsCorrectStudents()
    {
        ...
        Assert.Equal(2, result.Count);
        Assert.Contains("Иван", result[0].Name);
        Assert.Contains("Петр", result[1].Name);
    }
    ...
    public void GetStudentsOrderedByName_ReturnsSortedStudents()
    {
        ...
        Assert.Contains("Анна", result[0].Name);
        Assert.Contains("Иван", result[1].Name);
        Assert.Contains("Петр", result[2].Name);
    }
